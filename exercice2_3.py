...
def main():
    ...
    print("   git log --oneline           # Voir les commits")
    print("   git log -p                  # Voir les changements détaillés")
    print("   git rebase -i HEAD~4        # Rebase interactif")
    print("   # Marquez le commit 3 avec 'edit'")
    print("   ")
    print("   # Quand le rebase s'arrête sur le commit 3:")
    print("   git reset HEAD^             # Défaire le commit 3")
    print("   # Maintenant, créez 2 commits séparés:")
    print("   # 1. Un commit avec SEULEMENT la validation d'age")
    print("   # 2. Un commit avec SEULEMENT la méthode get_profile()")
    print("   git add -p exercices/exercice2_3/user.py  # Ajout sélectif")
